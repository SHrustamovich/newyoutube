    ...
    settings:(props) => (
      ...
      >
        <path
          fill="#fff"
          fillRule="evenodd"
          d="M27 15.525v-4.05h-3.585a9.924 9.924 0 0 0-1.47-3.555l2.52-2.52L21.6 2.535l-2.52 2.52a10.227 10.227 0 0 0-3.555-1.485V0h-4.05v3.57c-1.305.27-2.505.78-3.57 1.485l-2.52-2.52L2.52 5.4l2.52 2.52a9.924 9.924 0 0 0-1.47 3.555H0v4.05h3.57c.27 1.29.78 2.49 1.485 3.555L2.52 21.615l2.865 2.865 2.535-2.535a9.924 9.924 0 0 0 3.555 1.47V27h4.05v-3.585a9.852 9.852 0 0 0 3.54-1.47L21.6 24.48l2.865-2.865-2.535-2.535a10.227 10.227 0 0 0 1.485-3.555H27Zm-13.5 4.05A6.078 6.078 0 0 1 7.425 13.5 6.069 6.069 0 0 1 13.5 7.425a6.078 6.078 0 0 1 6.075 6.075c0 3.345-2.73 6.075-6.075 6.075Z"
          clipRule="evenodd"
          opacity={0.5}
        />
      </svg>
    ...
    pause: (props) => (
      ...
      >
        <path
          fill="#fff"
          fillRule="evenodd"
          d="M8.8 0H0v24h8.8V0ZM22 0h-8.8v24H22V0Z"
          clipRule="evenodd"
        />
      </svg>
    ),
    next:  (props) => (
      ...
      >
        <path
          fill="#fff"
          fillRule="evenodd"
          d="M10.8 0v5.985L0 0v16.5l10.8-6v6l12.45-6.6v6.6H27V0h-3.75v7.425L10.8 0Z"
          clipRule="evenodd"
        />
      </svg>
    ),
    volume:  (props) => (
      ...
      >
        <path
          fill="#fff"
          fillRule="evenodd"
          d="M21.36 12c0 4.725-3.345 8.37-7.86 9.465V24C19.485 22.86 24 17.91 24 12c0-5.925-4.515-10.875-10.5-12v2.52c4.515 1.095 7.86 4.74 7.86 9.48ZM10.5 23.25l-6.9-7.59H0V8.31h3.585L10.5.72v22.53ZM18 11.985c0-2.385-1.89-4.41-4.5-5.175v10.35c2.61-.765 4.5-2.775 4.5-5.175Z"
          clipRule="evenodd"
        />
        <rect
          width={86}
          ...
          rx={4}
        />
        <rect width={36} height={8} x={44} y={8} fill="#fff" rx={4} />
      </svg>
    ),
    subtitles: (props) => (
      <svg
      ...
      >
        <path
          fill="#fff"
          fillRule="evenodd"
          d="M0 18h27V0H0v18Zm12.075-6.75a3.45 3.45 0 0 1-.84 1.11c-.345.3-.75.54-1.2.69-.465.165-.975.24-1.53.24-.69 0-1.32-.105-1.86-.33a4.242 4.242 0 0 1-1.395-.945 4.226 4.226 0 0 1-.885-1.425 5.132 5.132 0 0 1-.3-1.755c0-.63.105-1.23.3-1.785.21-.54.495-1.02.885-1.44a4.06 4.06 0 0 1 1.395-.96c.54-.225 1.17-.345 1.86-.345.495 0 .96.06 1.41.21.435.135.825.33 1.185.585.345.27.63.585.855.975.24.39.375.825.435 1.32h-1.92a1.4 1.4 0 0 0-.225-.585 1.717 1.717 0 0 0-.45-.48 1.998 1.998 0 0 0-.585-.315c-.24-.09-.465-.12-.705-.12-.45 0-.825.075-1.14.24a2.08 2.08 0 0 0-.765.675c-.195.27-.33.585-.42.945-.09.345-.135.705-.135 1.08 0 .375.045.72.135 1.065.09.33.225.645.42.915.195.27.45.495.765.66.315.165.69.24 1.14.24.6 0 1.08-.165 1.41-.525.345-.36.555-.825.63-1.395h1.92c-.045.54-.18 1.02-.39 1.455Zm10.485.015c-.21.435-.48.795-.825 1.095-.345.315-.75.54-1.215.705-.465.165-.975.24-1.53.24-.69 0-1.305-.105-1.86-.345a3.83 3.83 0 0 1-1.395-.945 3.987 3.987 0 0 1-.87-1.41 4.8 4.8 0 0 1-.315-1.755c0-.645.105-1.23.315-1.785a4.116 4.116 0 0 1 .87-1.44c.375-.405.84-.735 1.395-.96.555-.24 1.17-.345 1.86-.345.495 0 .96.06 1.41.195.435.135.84.345 1.185.6.345.255.645.585.87.975.225.375.36.825.42 1.32h-1.92a1.386 1.386 0 0 0-.225-.6c-.12-.18-.255-.33-.435-.48-.18-.135-.39-.24-.6-.315a2.231 2.231 0 0 0-.705-.105c-.45 0-.825.075-1.14.24-.3.165-.555.39-.75.66-.195.285-.345.6-.435.945-.075.36-.12.72-.12 1.095 0 .36.045.72.12 1.05.09.345.24.66.435.93s.45.495.75.66c.315.15.69.24 1.14.24.6 0 1.08-.18 1.425-.525.345-.36.54-.825.615-1.395h1.92a4.173 4.173 0 0 1-.39 1.455Z"
          clipRule="evenodd"
          opacity={0.5}
        />
      </svg>
    ...
    size:  (props) => (
      ...
      >
        <path
          fill="#fff"
          fillRule="evenodd"
          d="M0 0h30v21H0V0Zm4.5 16.5h21v-12h-21v12Z"
          clipRule="evenodd"
          opacity={0.5}
        />
      </svg>
    ...
    screen: (props) => (
      ...
      >
        <path
          fill="#fff"
          fillRule="evenodd"
          d="M0 9h4.5V4.5H9V0H0v9Zm24-9v4.5h4.5V9H33V0h-9Zm0 19.5V24h9v-9h-4.5v4.5H24ZM4.5 15H0v9h9v-4.5H4.5V15Z"
          clipRule="evenodd"
          opacity={0.5}
        />
      </svg>
